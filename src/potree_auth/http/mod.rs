...
mod router_integration_tests {
    ...
    use super::*;
    use crate::http::routes::HEALTH_CHECK;
    use crate::http::routes::POTREE_ASSETS;
    use crate::http::routes::POTREE_UI_PROJECT;
    use crate::http::routes::PROJECT_ASSETS;
    ...
    mod project_static_assets {
        ...
        use crate::http::routes::ProjectAssetParams;
